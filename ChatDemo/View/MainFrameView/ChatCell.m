...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        CGFloat  timeHeight = 21;
        CGFloat timeWidth = 40;
        CGFloat timeLeftSpace = 5;
        _time = [[UILabel alloc]initWithFrame:CGRectMake((self.frame.size.width-timeLeftSpace), (self.frame.origin.y+self.frame.size.height/3-10), timeWidth, timeHeight)];
